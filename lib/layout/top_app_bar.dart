              ...
              children: [
                ...
                Container(
                  ...
                  children: [
                    ...
                    Container(padding: const EdgeInsets.symmetric(horizontal: 10.0),                                                          
                      decoration: BoxDecoration(
                        border: Border.all(width: 1, color: Colors.grey),
                        borderRadius: BorderRadius.circular(10)
                      ),
                      child: Center(                                   
                        child: Text('User name', style: kTextStyle.copyWith(fontWeight: FontWeight.w400, color: kWhite)),
                      ),
                    ),
                    Center(
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton( 
                          ...
                          icon: const Icon(Icons.arrow_drop_down, size: 30, color: kWhite,),
                          items: const[
                            DropdownMenuItem(
