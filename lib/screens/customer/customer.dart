                    ...
                    children: [
                      Visibility(
                        ...
                        child: Container(
                          ...
                          width: 150,
                          child: const Center(
                            child:  Text('Customer', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w600, color: kWhite)),
                          ),
                        ),
                      ),
                  ...
                  child: Container(
                    ...
                    child: DataTable(
                      ...
                      columns: const [
                        ...
                        DataColumn(label: Text("Requirements", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700))),
...
DataRow listAccountsDataRow(AccountModel account, BuildContext context){
      return DataRow(
        ...
        DataCell(Text("${account.numberReq}", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600))),
        DataCell(Text("${account.spending}", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600))),
